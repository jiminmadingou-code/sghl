      ...
      <div class="modal-box">
        ...
        <div class="space-y-3">
          <div class="grid grid-cols-2 gap-3">
            ...
            <div>
              <label class="block text-xs font-semibold text-gray-600 mb-1">Semaines d'aménorrhée *</label>
            ...
            <div>
              ...
              <select v-model="newGrossesse.type" class="input-field">
                ...
                <option>Gémellaire</option>
                <option>Triple</option>
              </select>
            </div>
            <div>
              <label class="block text-xs font-semibold text-gray-600 mb-1">Niveau de risque</label>
